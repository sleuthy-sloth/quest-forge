        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            <p className="font-body italic text-2xl text-[#f0e6c8]/90 leading-loose mb-12">
              &ldquo;The Light of the Embershard is not found in grand battles, but in the quiet discipline of the every day. 
              Each deed is a spark. Together, we shall build a fire that the Hollow cannot quench.&rdquo;
            </p>
