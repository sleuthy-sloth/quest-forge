...
function AstrolabeRing({ size }: { size: number }) {
  ...
  return (
    ...
    >
      ...
      <circle cx={cx} cy={cy} r={innerR} fill="none" stroke="rgba(232,160,32,0.09)" strokeWidth="0.75" strokeDasharray="5 12" />
            ...
            <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
              <div style={{ display: 'inline-block', marginBottom: '1rem' }}>
                <svg width="52" height="52" viewBox="0 0 52 52">
                  ...
                  <circle cx="26" cy="26" r="16" fill="none" stroke="rgba(232,160,32,0.1)" strokeWidth="0.5" strokeDasharray="3 8" />
                  {[0, 90, 180, 270].map(d => {
                    const r = (d - 90) * Math.PI / 180
                    return <circle key={d} cx={26 + 24 * Math.cos(r)} cy={26 + 24 * Math.sin(r)} r="2.2" fill="rgba(201,168,76,0.6)" />
                  })}
                  <circle cx="26" cy="26" r="6" fill="rgba(232,160,32,0.08)" stroke="rgba(201,168,76,0.38)" strokeWidth="1" />
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '0.75rem 0' }}>
                ...
                <span style={{ color: 'rgba(201,168,76,0.35)', fontFamily: 'var(--font-heading), Cinzel, serif', fontSize: '0.48rem', letterSpacing: '0.2em' }}>✦ ✦ ✦</span>
            ...
            >
              {([
                ...
                <button
                  ...
                  style={{
                    background: tab === t.id
                      ? 'linear-gradient(135deg, rgba(201,125,10,0.15), rgba(232,160,32,0.08))'
...
function SuccessMessage({ msg }: { msg: string | null }) {
  ...
  return (
    <div role="status" style={{
      ...
      <p style={{ fontFamily: 'var(--font-body), \'Crimson Text\', Georgia, serif', fontWeight: 400, color: 'rgba(210,235,220,0.9)', fontSize: '0.88rem' }}>
        {msg}
      </p>
    </div>
  )
