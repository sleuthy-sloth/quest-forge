...
const QuizInterface = dynamic(() => import('@/components/games/QuizInterface'), {
  loading: () => <div className="min-h-[80vh] flex items-center justify-center text-[#c9a84c]/40 font-pixel text-xs tracking-widest animate-pulse">Calculating the variables...</div>,
  ssr: true,
})
