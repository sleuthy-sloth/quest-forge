...
export const SPRITE_MANIFEST = {
  ...
  pants: {
    pants: {
      ...
      pathMale: 'clothing/legs/pants/male/{color}.png',
    ...
    plate_legs: {
      ...
      category: 'pants',
      path: 'clothing/legs/plate_legs/female/{color}.png',
      pathMale: 'clothing/legs/plate_legs/male/{color}.png',
  ...
  shirt: {
    longsleeve: {
      ...
      category: 'shirt',
      path: 'clothing/torso/longsleeve/female/{color}.png',
      pathMale: 'clothing/torso/longsleeve/male/{color}.png',
      colorVariants: STANDARD_COLORS,
      bodyType: 'universal',
    },
    shortsleeve: {
      ...
      category: 'shirt',
      path: 'clothing/torso/shortsleeve/female/{color}.png',
      pathMale: 'clothing/torso/shortsleeve/male/{color}.png',
      colorVariants: STANDARD_COLORS,
      bodyType: 'universal',
    },
    leather_armour: {
      ...
      category: 'shirt',
      path: 'clothing/torso/leather_armour/female/{color}.png',
      pathMale: 'clothing/torso/leather_armour/male/{color}.png',
      colorVariants: STANDARD_COLORS,
      bodyType: 'universal',
    },
    plate_armour: {
      ...
      category: 'shirt',
      path: 'clothing/torso/plate_armour/female/{color}.png',
      pathMale: 'clothing/torso/plate_armour/male/{color}.png',
      colorVariants: METAL_COLORS,
      bodyType: 'universal',
    },
    chainmail: {
