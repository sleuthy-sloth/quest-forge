-- ============================================================
-- Quest Forge — Migration 010
-- Auto-seed edu_challenges (600 questions)
-- ============================================================
-- Idempotent: only runs the inserts if the table is empty so
-- repeated supabase db push calls are safe.

DO $seed$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM edu_challenges LIMIT 1) THEN
